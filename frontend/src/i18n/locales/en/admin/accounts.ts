export default {
    accounts: {
      ...
      kiro: {
        authMode: 'Auth Mode',
        authModeDesktop: 'Kiro Desktop',
        authModeSsoOidc: 'AWS SSO OIDC',
        authModeHint: 'Kiro Desktop uses the refreshToken endpoint; AWS SSO OIDC additionally requires client_id/client_secret.',
        refreshToken: 'Refresh Token',
        refreshTokenHint: 'Required. Used to refresh the Kiro access token automatically.',
        refreshTokenRequired: 'Please enter the Kiro refresh token',
        accessToken: 'Access Token',
        accessTokenHint: 'Optional. May be expired; the backend refreshes it automatically.',
        profileArn: 'Profile ARN',
        profileArnHint: 'Optional. CodeWhisperer profile ARN; region is auto-detected from it if not set.',
        region: 'Region',
        regionHint: 'API region for runtime.{region}.kiro.dev (default us-east-1).',
        clientId: 'Client ID',
        clientSecret: 'Client Secret',
        ssoOidcHint: 'Required only for AWS SSO OIDC auth mode.',
        ssoOidcCredsRequired: 'AWS SSO OIDC requires client_id and client_secret',
      },
