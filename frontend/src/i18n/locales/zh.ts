export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      kiro: {
        authMode: '认证方式',
        authModeDesktop: 'Kiro 桌面端',
        authModeSsoOidc: 'AWS SSO OIDC',
        authModeHint: 'Kiro 桌面端使用 refreshToken 端点刷新；AWS SSO OIDC 还需要 client_id/client_secret。',
        refreshToken: 'Refresh Token',
        refreshTokenHint: '必填。用于自动刷新 Kiro 访问令牌。',
        refreshTokenRequired: '请输入 Kiro refresh token',
        accessToken: 'Access Token',
        accessTokenHint: '可选。可能已过期，后端会自动刷新。',
        profileArn: 'Profile ARN',
        profileArnHint: '可选。CodeWhisperer profile ARN；未填 region 时会从中自动解析。',
        region: 'Region',
        regionHint: 'runtime.{region}.kiro.dev 的 API 区域（默认 us-east-1）。',
        clientId: 'Client ID',
        clientSecret: 'Client Secret',
        ssoOidcHint: '仅 AWS SSO OIDC 认证方式需要。',
        ssoOidcCredsRequired: 'AWS SSO OIDC 需要 client_id 和 client_secret',
      },
